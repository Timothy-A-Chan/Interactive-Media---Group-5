...
void peopleCounterGenerator(){
  //Shows number of people and time
    ...
    int a = (int) random(0, 1200);
    int b = (int) random(300, 700);
    ...
    circle(a, b, headRadius); //head
    line(a, b + (headRadius/2), a, b + 100); //spine
    
    if(a > 300)
    {
      line(a, b + 50, a - 20, b + 50);
      line(a - 20, b + 50, a - 20, b + 70);
  
      line(a, b + 50, a + 20, b + 50);
      line(a + 20, b + 50, a + 20, b + 30);
    ...
    line(a, b + 100, a - 30, b + 100 + 20); // left leg
    line(a, b + 100, a + 30, b + 100 + 20); // right leg
